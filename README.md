...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/first_look.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/push-create_type.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/create_type.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/menubar-open_list.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/choose_file.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/main/documents/raw-dataFile.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/add-object_type.png)

The List Editor also allows us to add pre-created types to our set, so let's add a couple.

![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/form-list.png)

Our list looks finished. Now it's time to save our changes. Just click on the "Save file" option.

![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/menubar-saveList.png)

## Create New List

To create a new list, choose "New List..." in the menubar.

![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/menubar-new_list.png)

It opens a small window to type the name. It shouldn't contan spaces. It already suggests you .txt extenshion.

![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/enterFileName.png)

After that, you need to select a directory to place the new file.

![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/choose_folder.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/undo-option.png)
...
![alt text](https://github.com/denis-kolchev/Game-Object-List-Editor/blob/main/documents/list-editing.png)
